...
class quad(object):
	...
	# CH: 1/17/18
	# catch triangles which don't have 3 different indices
	for t in t0, t1:
		assert t[0] != t[1] and t[0] != t[1] and t[1] != t[2], "get_triangles_with_indexed_verts() error: " + str(t) + " has duplicate vertex ids!"
