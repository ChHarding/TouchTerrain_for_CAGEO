...
GOOGLE_MAPS_KEY_FILE = os.getenv(
    "TOUCHTERRAIN_GOOGLE_MAPS_KEY_FILE",
    os.path.join(config.SERVER_DIR, "GoogleMapsKey.txt"),
)
...
DEBUG_MODE = "SERVER_SOFTWARE" in os.environ and os.environ[
    "SERVER_SOFTWARE"
].startswith("Dev")
...
TMP_FOLDER = os.getenv(
    "TOUCHTERRAIN_TMP_FOLDER", os.path.join(config.SERVER_DIR, "tmp")
)
DOWNLOADS_FOLDER = os.getenv(
    "TOUCHTERRAIN_DOWNLOADS_FOLDER", os.path.join(config.SERVER_DIR, "downloads")
)
PREVIEWS_FOLDER = os.getenv(
    "TOUCHTERRAIN_PREVIEWS_FOLDER", os.path.join(config.SERVER_DIR, "previews")
)
