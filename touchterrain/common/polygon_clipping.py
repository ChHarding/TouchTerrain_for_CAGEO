...
from touchterrain.common.shapely_plot import plot_shapely_polygon_intersection
        ...
        for j in range(0, surface_raster_variant.original.shape[0]): # Y
            for i in range(0, surface_raster_variant.original.shape[1]): # X
                ...
                if isinstance(clippingPrint2DPoly, shapely.Polygon):
                    ...
                    # Debug plot of a clipping anc cell polygon intersection
                    if j==97 and i==45:
                        quadPrint2DPoly = shapely.Polygon(quadPrint2DCoords)
                        
                        plot_shapely_polygon_intersection([clippingPrint2DPoly, quadPrint2DPoly])
                        pass
                else:
