...
def store_static_Google_map(bllon, trlon, bllat, trlat, google_maps_key, temp_folder, zip_file_name):
    '''Grabs and stores a static google map of the area. 
...
# given the appropriate thresholds and step sizes. Work with negative values as well.
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        print(elevmin, elevmax, elevmax-elevmin, ticks)
