...
EE_ACCOUNT = os.getenv(
    "TOUCHTERRAIN_EE_ACCOUNT", "earthengine@touchterrain.iam.gserviceaccount.com"
)

EE_CREDS = os.getenv(
    "TOUCHTERRAIN_EE_SA_CREDS",
    os.path.join(Path.home(), "earthengine", ".config", ".private-key.json"),
)
